  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="#" data-toggle="modal" data-target="#login"></span>&nbsp;Admin Login<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="#" data-toggle="modal" data-target="#myModal"></span>&nbsp;User Login</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="feedback.php" target="_blank"></span>&nbsp;Feedback</a></li></ul>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="College" class="form-control input-md" type="text">
...
<div style="color: #e2e2e2;"><div id="footer" title = "Designed & Developed by"> Copyrights 2022, By Sajith Umar, Syed Hannan, Syeda Zobia Tazeen</div></div>
